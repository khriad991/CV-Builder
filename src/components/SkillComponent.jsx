...
const SkillComponent = () => {
    ...
    return (
        <section className={hidden ? "py-10 mt-28 h-screen w-screen bg-gray-50 z-0 bg-opacity-25":"py-10 mt-28 px-6 h-screen w-screen "}>
            <div className="container flex justify-center items-center flex-col gap-y-10 relative -z-0">
                ...
                <div className={hidden ?"absolute top-20 left-center z-10 overflow-hidden flex justify-center items-center flex-col gap-y-3.5 bg-white shadow px-2 sm:px-6 md:px-8 py-8 w-full md:max-w-[500px] border-[.1px] border-sky-200 rounded-lg":"hidden "}>
